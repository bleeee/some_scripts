apt update -y
#apt upgrade -y
apt install minicom p7zip-full python3-smbus python3-pillow python3-numpy python3-rpi.gpio vlc wireguard ffmpeg udhcpc traceroute dnsutils resolvconf -y
